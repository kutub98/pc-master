  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        />
        <img
          src="https://images.unsplash.com/photo-1416339442236-8ceb164046f8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1403&q=80"
          alt="image 3"
          className="h-full w-full object-cover"
        />
      </Carousel>
